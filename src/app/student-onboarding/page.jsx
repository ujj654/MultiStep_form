...
export default function StudentOnboardingPage() {
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-4">
      <div className="mx-auto w-full max-w-5xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-4 md:p-10 dark:bg-gray-800 dark:border-gray-700 grid grid-cols-12 gap-4 min-h-[90vh]">
        {/* Steps */}
        <Steps steps={steps} />
        {/* Form */}
