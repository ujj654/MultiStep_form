...
export default function PersonalInfoForm() {
  ...
  return (
    <form className="px-12 py-4" onSubmit={handleSubmit(processData)}>
      <div className="mb-8">
        <h5 className="text-xl md:text-3xl font-bold text-gray-800 dark:text-white">
          Personal info name
        </h5>
        <p className="text-gray-800 dark:text-white">Please provide your name,email address,and phone number.</p>
      </div>
